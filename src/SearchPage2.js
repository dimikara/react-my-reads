        ...
        */
        if (query) {
            BooksAPI.search(query).then((matchedBooks) => {
                /*
                * The first nested "if" handles the case where
                * no books match the search. In this case, a new component
                * is called informing the user of the lack of results.
                * The second nested "if" covers the case of an error.
